...
A2C_INLINE A2C_ERROR A2C_EncodeDer_T0(T0 const * p, int flags, A2C_CONTEXT ** ppcxt, PA2C_STREAM pstm) { return A2C_EncodeBer((PVOID) p, &T0_descriptor, flags, ppcxt, pstm); }
A2C_INLINE A2C_ERROR A2C_DecodeDer_T0(T0 ** p, int flags, A2C_CONTEXT ** ppcxt, PCBYTE pb, size_t cb) { return A2C_DecodeBer((PVOID *) p, &T0_descriptor, flags, ppcxt, pb, cb); }
A2C_INLINE A2C_ERROR A2C_Copy_T0(T0 * pDst, T0 * pSrc) { return A2C_Copy((PVOID) pDst, (PCVOID) pSrc, &T0_descriptor); }
A2C_INLINE A2C_ERROR A2C_Compare_T0(T0 const * pLeft, T0 const * pRight) { return A2C_Compare((PCVOID) pLeft, (PCVOID) pRight, &T0_descriptor); }
...
A2C_INLINE A2C_ERROR A2C_EncodeDer_T1(T1 const * p, int flags, A2C_CONTEXT ** ppcxt, PA2C_STREAM pstm) { return A2C_EncodeBer((PVOID) p, &T1_descriptor, flags, ppcxt, pstm); }
A2C_INLINE A2C_ERROR A2C_DecodeDer_T1(T1 ** p, int flags, A2C_CONTEXT ** ppcxt, PCBYTE pb, size_t cb) { return A2C_DecodeBer((PVOID *) p, &T1_descriptor, flags, ppcxt, pb, cb); }
A2C_INLINE A2C_ERROR A2C_Copy_T1(T1 * pDst, T1 * pSrc) { return A2C_Copy((PVOID) pDst, (PCVOID) pSrc, &T1_descriptor); }
A2C_INLINE A2C_ERROR A2C_Compare_T1(T1 const * pLeft, T1 const * pRight) { return A2C_Compare((PCVOID) pLeft, (PCVOID) pRight, &T1_descriptor); }
...
A2C_INLINE A2C_ERROR A2C_EncodeDer_T2(T2 const * p, int flags, A2C_CONTEXT ** ppcxt, PA2C_STREAM pstm) { return A2C_EncodeBer((PVOID) p, &T2_descriptor, flags, ppcxt, pstm); }
A2C_INLINE A2C_ERROR A2C_DecodeDer_T2(T2 ** p, int flags, A2C_CONTEXT ** ppcxt, PCBYTE pb, size_t cb) { return A2C_DecodeBer((PVOID *) p, &T2_descriptor, flags, ppcxt, pb, cb); }
A2C_INLINE A2C_ERROR A2C_Copy_T2(T2 * pDst, T2 * pSrc) { return A2C_Copy((PVOID) pDst, (PCVOID) pSrc, &T2_descriptor); }
A2C_INLINE A2C_ERROR A2C_Compare_T2(T2 const * pLeft, T2 const * pRight) { return A2C_Compare((PCVOID) pLeft, (PCVOID) pRight, &T2_descriptor); }
...
A2C_INLINE A2C_ERROR A2C_EncodeDer_T3(T3 const * p, int flags, A2C_CONTEXT ** ppcxt, PA2C_STREAM pstm) { return A2C_EncodeBer((PVOID) p, &T3_descriptor, flags, ppcxt, pstm); }
A2C_INLINE A2C_ERROR A2C_DecodeDer_T3(T3 ** p, int flags, A2C_CONTEXT ** ppcxt, PCBYTE pb, size_t cb) { return A2C_DecodeBer((PVOID *) p, &T3_descriptor, flags, ppcxt, pb, cb); }
A2C_INLINE A2C_ERROR A2C_Copy_T3(T3 * pDst, T3 * pSrc) { return A2C_Copy((PVOID) pDst, (PCVOID) pSrc, &T3_descriptor); }
A2C_INLINE A2C_ERROR A2C_Compare_T3(T3 const * pLeft, T3 const * pRight) { return A2C_Compare((PCVOID) pLeft, (PCVOID) pRight, &T3_descriptor); }
...
A2C_INLINE A2C_ERROR A2C_EncodeDer_T4(T4 const * p, int flags, A2C_CONTEXT ** ppcxt, PA2C_STREAM pstm) { return A2C_EncodeBer((PVOID) p, &T4_descriptor, flags, ppcxt, pstm); }
A2C_INLINE A2C_ERROR A2C_DecodeDer_T4(T4 ** p, int flags, A2C_CONTEXT ** ppcxt, PCBYTE pb, size_t cb) { return A2C_DecodeBer((PVOID *) p, &T4_descriptor, flags, ppcxt, pb, cb); }
A2C_INLINE A2C_ERROR A2C_Copy_T4(T4 * pDst, T4 * pSrc) { return A2C_Copy((PVOID) pDst, (PCVOID) pSrc, &T4_descriptor); }
A2C_INLINE A2C_ERROR A2C_Compare_T4(T4 const * pLeft, T4 const * pRight) { return A2C_Compare((PCVOID) pLeft, (PCVOID) pRight, &T4_descriptor); }
